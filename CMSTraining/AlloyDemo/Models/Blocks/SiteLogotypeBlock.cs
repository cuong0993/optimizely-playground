...
namespace AlloyDemo.Models.Blocks
{
    ...
    [SiteContentType(
        ...
        AvailableInEditMode =
            false)] // Should not be created and added to content areas by editors, the SiteLogotypeBlock is only used as a property type
    [SiteImageUrl]
    public class SiteLogotypeBlock : SiteBlockData
    {
        ...
        [CultureSpecific] public virtual string Title { get; set; }
    }
}