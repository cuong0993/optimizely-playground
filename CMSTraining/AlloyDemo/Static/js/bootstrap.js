...
!function($) {
    ...
    * ================= */
    ...
    $(function() {
        $("body").on("click.carousel.data-api",
            "[data-slide]",
            function(e) {
                var $this = $(this),
                    href,
    ...
    * ===================== */
    ...
    function escape() {
        ...
        if (this.isShown && this.options.keyboard) {
            $(document).on("keyup.dismiss.modal",
                function(e) {
    ...
    Tooltip.prototype = {
        ...
        isHTML: function(text) {
            ...
            return typeof text != "string" ||
                (text.charAt(0) === "<" && text.charAt(text.length - 1) === ">" && text.length >= 3
                ) ||
                /^(?:[^<]*<[\w\W]+>[^>]*$)/.exec(text);
        },
        setContent: function() {
