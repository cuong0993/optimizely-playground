...
namespace AlloyDemo.Helpers
{
    public static class HtmlHelpers
    {
            ...
            bool requirePageTemplate = true)
        {
            ...
            foreach (var menuItem in menuItems) itemTemplate(menuItem).WriteTo(writer);
            ...
            IHtmlString url, string title = null, string cssClass = null)
        {
            if (shouldWriteLink)
            {
                ...
                if (!string.IsNullOrWhiteSpace(title)) linkTag.Attributes.Add("title", helper.Encode(title));

                if (!string.IsNullOrWhiteSpace(cssClass)) linkTag.Attributes.Add("class", cssClass);
            ...
            Func<IHtmlString> urlGetter, string title = null, string cssClass = null)
        {
            ...
            if (shouldWriteLink) url = urlGetter();
        ...
        public class ConditionalLink : IDisposable
        {
            ...
            protected virtual void Dispose(bool disposing)
            {
                ...
                if (_linked) _viewContext.Writer.Write("</a>");
            }
        }
    }
}