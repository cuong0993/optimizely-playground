...
namespace AlloyDemo.Helpers
{
    public static class UrlHelpers
    {
        ...
        {
            if (ContentReference.IsNullOrEmpty(contentLink)) return MvcHtmlString.Empty;
        ...
        public static RouteValueDictionary GetPageRoute(this RequestContext requestContext,
