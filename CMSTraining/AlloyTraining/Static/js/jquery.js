    ...
    jQuery.extend({
        Deferred: function(func) {
            ...
            deferred.done(function() {
                ...
                failList.disable,
                progressList.lock).fail(function() {
                    state = "rejected";
                },
                doneList.disable,
                progressList.lock);
                    ...
                    jQuery.each(scripts,
                        function(i, elem) {
                            if (elem.src) {
                                ...
                                jQuery.globalEval(
                                    (elem.text || elem.textContent || elem.innerHTML || "").replace(rcleanScript,
                                        "/*$0*/"));
                            }
    ...
    jQuery.fx.prototype = {
        ...
        hide: function() {
            ...
            this.options.orig[this.prop] =
                jQuery._data(this.elem, "fxshow" + this.prop) || jQuery.style(this.elem, this.prop);
        ...
        step: function(gotoEnd) {
            ...
            if (gotoEnd || t >= options.duration + this.startTime) {
                ...
                if (options.duration == Infinity) {
                    ...
                    this.pos = jQuery.easing[options.animatedProperties[this.prop]](this.state,
                        n,
                        0,
                        1,
                        options.duration);
...
// Ensure props that can't be negative don't go there on undershoot easing
    jQuery.each(fxAttrs.concat.apply([], fxAttrs),
        function(i, prop) {
